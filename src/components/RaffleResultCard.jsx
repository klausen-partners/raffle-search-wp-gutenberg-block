 ...
 * @param {string[]}                                     [props.hiddenTags]
 * @param {string}                                       [props.tagsMode]
 * @param {string[]}                                     [props.hiddenTypes]
 * @param {string}                                       [props.typesMode]
 */
export default function RaffleResultCard({
	...
	const typeTag = getResultTypeLabel(resultType);
	const showTypeTag =
		hiddenTypes.length === 0 ||
		(typesMode === 'exclude'
			? !hiddenTypes.includes(resultType)
			: hiddenTypes.includes(resultType));
